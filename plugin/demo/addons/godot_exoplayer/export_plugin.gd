...
class AndroidExportPlugin extends EditorExportPlugin:
	...
	func _get_android_dependencies(platform, debug):
		...
		if debug:
			return PackedStringArray(["androidx.media3:media3-exoplayer:1.4.1","androidx.media3:media3-exoplayer-dash:1.4.1","androidx.media3:media3-ui:1.4.1","androidx.media3:media3-exoplayer-hls:1.4.1"])
		else:
			return PackedStringArray(["androidx.media3:media3-exoplayer:1.4.1","androidx.media3:media3-exoplayer-dash:1.4.1","androidx.media3:media3-ui:1.4.1","androidx.media3:media3-exoplayer-hls:1.4.1"])
